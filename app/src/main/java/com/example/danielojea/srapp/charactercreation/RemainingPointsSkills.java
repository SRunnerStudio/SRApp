...
public class RemainingPointsSkills extends AppCompatActivity {
    ArrayList<Skill> skills;
    SRCharacter character;
    RecyclerView recyclerView;
    RemPointsSkillListAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        skillpointPackageCounter.setText("");
        ...
        mAdapter = new RemPointsSkillListAdapter(character,(TextView)findViewById(R.id.SkillpointCounter),(TextView)findViewById(R.id.SkillpointPackageCounter));
    ...
    public void startNextActivity(View v){
        ...
        Intent intent = new Intent(this, RemPointsKnowledgeSkills.class);
